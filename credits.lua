...
tonyimagepath = "assets/graphics/tonyimg.png"
montemuroimagepath = "assets/graphics/montemuroimg.png"
owenimagepath = "assets/graphics/owenimg.png"
tiedemannimagepath = "assets/graphics/tiedemannimg.png"
...
function scene:create( event )
   ...
   local tonyimage = display.newImage(sceneGroup, tonyimagepath)
   tonyimage.x = display.contentCenterX
   tonyimage.y = display.contentCenterY - 500
   tonyimage.xScale = 1.25--.82
   tonyimage.yScale = 1.25--.82
   --title.size = 115

   local montemuroimage = display.newImage(sceneGroup, montemuroimagepath)
   montemuroimage.x = display.contentCenterX
   montemuroimage.y = display.contentCenterY - 350
   montemuroimage.xScale = 1.25--.82
   montemuroimage.yScale = 1.25--.82

   local owenimage = display.newImage(sceneGroup, owenimagepath)
   owenimage.x = display.contentCenterX
   owenimage.y = display.contentCenterY
   owenimage.xScale = 1.25--.82
   owenimage.yScale = 1.25--.82
   --title.size = 115

   local tiedemannimage = display.newImage(sceneGroup, tiedemannimagepath)
   tiedemannimage.x = display.contentCenterX
   tiedemannimage.y = display.contentCenterY + 150
   tiedemannimage.xScale = 1.25--.82
   tiedemannimage.yScale = 1.25--.82
